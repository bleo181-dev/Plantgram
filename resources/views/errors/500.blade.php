...
<main class="page fade-in">
	<div id="top-bar" class="top-bar">
		<span class="action-btn action-btn_primary"><a href="{{ URL::action('SerraController@index') }}">&larr; Torna alla tua serra</a></span>
		<span class="game-counter-panel"><span id="game-counter" class="game-counter">99</span> piccoli insetti che infestano le tue piante</span>
	</div>
	<div class="flex-container" id="error-message">
		<div>
			<h1>500</h1>
			<h2>Oooops! Errore interno del Server. Qualcosa è andato storto.</h2>
		</div>
		<div>
			<p>
				Non ti preoccupare, siamo a conoscenza della situazione. Nel frattempo aiutaci a  <span class="underlined">disinfestare questi famelici insetti</span>. Ti abbiamo fornito la nostra arma più letale!
			</p>
		</div>
	</div>
	<div id="game-canvas">
